--[[
	this script is for anyone who only wanted the smooth camera
	so yeee here it is
...
--[[
	some may not be working functional if your running this in 0.5.2h and below
--]]

--[[ Sacorg's Engine Looking Settings
	shiftCameraOnNote = true
	shiftCameraPixels = 64
	smoothCamera = true
	smoothZoom = true
	smoothIntensity = .875
--]]
...
local settings = {
	...
	smoothCamera = false,
	smoothZoom = true,
	smoothIntensity = .875 -- too much smooth or below 0 = camera wont move lmao
}
